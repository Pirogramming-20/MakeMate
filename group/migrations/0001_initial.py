# Generated by Django 4.2.6 on 2024-02-05 15:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('my_team_idea', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_team_idea_set', to='group.idea')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
