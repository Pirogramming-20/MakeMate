...
def group_detail_info(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            group_ability_description1 = form.cleaned_data[
                "ability_description1"]
            group_ability_description2 = form.cleaned_data[
                "ability_description2"]
            group_ability_description3 = form.cleaned_data[
                "ability_description3"]
            group_ability_description4 = form.cleaned_data[
                "ability_description4"]
            group_ability_description5 = form.cleaned_data[
