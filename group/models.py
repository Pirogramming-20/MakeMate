...
end_date_choice = (
    (timezone.now().date() + timezone.timedelta(days=2), '2일 뒤'),
    (timezone.now().date() + timezone.timedelta(days=3), '3일 뒤'),
    (timezone.now().date() + timezone.timedelta(days=4), '4일 뒤'),
    (timezone.now().date() + timezone.timedelta(days=5), '5일 뒤'),
)
