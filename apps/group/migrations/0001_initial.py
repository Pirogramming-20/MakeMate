# Generated by Django 5.0.1 on 2024-02-19 01:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="실력1 설명"
                    ),
                ),
                (
                    "ability_description2",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="실력2 설명"
                    ),
                ),
                (
                    "ability_description3",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="실력3 설명"
                    ),
                ),
                (
                    "ability_description4",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="실력4 설명"
                    ),
                ),
                (
                    "ability_description5",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="실력5 설명"
                    ),
                ),
                ...
                (
                    "first_end_date",
                    models.DateTimeField(default=datetime.date(2024, 2, 20)),
                ),
                (
                    "second_end_date",
                    models.DateTimeField(default=datetime.date(2024, 2, 21)),
                ),
                (
                    "third_end_date",
                    models.DateTimeField(default=datetime.date(2024, 2, 22)),
                ),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(max_length=31, null=True, verbose_name="아이디어 이름"),
                ),
                (
                    "intro",
                    models.CharField(
                        max_length=50, null=True, verbose_name="아이디어 한 줄 소개"
                    ),
                ),
                (
                    "file",
                ...
                (
                    "content",
                    models.TextField(
                        default="기본 설명", max_length=1000, verbose_name="아이디어 설명"
                    ),
                ),
